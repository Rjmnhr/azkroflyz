...
const TemplateComponent: React.FC = () => {
  ...
  return (
    <div
      className={` layout-menu-100vh ${
        isToggleMenu ? "layout-menu-expanded" : ""
      }  `}
    >
      <body>
                          ...
                          <div className="col-sm-7">
                            <div className="card-body">
                              ...
                              <p className="mb-4">
                                ...
                                personalized insights to navigate your career
                                path effectively
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="card-body">
                            ...
                            <h3 className="card-title text-nowrap mb-2">
                              {Math.round(
                                ...
                                ? Math.round(
                                    (ugDegreeAndUGTierMatch / UGDegreeMatch) *
                                      100
                                  )
                                : 0}{" "}
                              %
                        ...
                        <div className="row row-bordered g-0">
                          ...
                          <div className="col-md-4">
                            <div className="card-body">
                              ...
                              <p>
                                {" "}
                                Average job change required for someone with
                                your profile to become{" "}
                                <span className="text-primary">
                                  {desiredTitle}
                                </span>{" "}
                              </p>
                    ...
                    <div className="col-12 col-md-8 col-lg-4 order-3 order-md-2">
                      ...
                      <div className="card mb-3">
                        <div className="card-body">
                          <div className="card-title">
                            <strong>
                              Your profile matching in our database
                            </strong>
                          </div>
                        </div>
                      </div>
